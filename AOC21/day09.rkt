...
#|
 ...
 adjacent locations.  What is the sum of the risk levels of all low points on your heightmap?
...
;; a grid is a structure (make-grid Natural Natural (Vector-of Natural))
